  ...
  const situations = [
    {
      id: 1,
      mbti: "E",
      text: "크리스마스를 앞둔 금요일, 오늘 안에 끝내야 할 일이 산더미인데... 어떡하지?",
    ...
    },
    {
      ...
      pos: "한번 짠 계획은 끝까지 지킨다.",
      neg: "즉흥적으로 계획을 바꿔가며 일한다.",
    },
    {
      id: 4,
      mbti: "F",
      text: "내 도움 없이는 동료 혼자 야근을 할 것 같다면?",
      pos: "내가 도움이 된다면야… 함께 야근한다.",
    ...
    },
    {
      ...
      neg: "어색해지기 전에 알던 사람을 찾는다.",
    },
    {
      id: 8,
      mbti: "F",
      text: "으아! 친구가 내 옷에 와인을 쏟았다…",
      pos: "친구가 민망하지 않게 몇 번이고 괜찮다고 말해준다.",
      neg: "실수인 건 알지만 그래도 세탁비는 받는다.",
    },
    {
      id: 9,
      mbti: "F",
      text: "크리스마스, 모두들 축하와 선물로 떠들썩한듯 하다",
